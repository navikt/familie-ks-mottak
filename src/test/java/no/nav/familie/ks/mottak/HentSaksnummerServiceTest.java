...
public class HentSaksnummerServiceTest {
    ...
    private HentSaksnummerService service;
    ...
    public void setUp() {
        ...
        service = new HentSaksnummerService(OPPSLAG_BASE_URL, stsRestClient, søknadRepository, restTemplate);
    }

    @ParameterizedTest
    @NullAndEmptySource
    public void skal_kaste_feil_hvis_payload_ikke_er_nummer(String payload) {
    ...
    @Test
    public void skal_kaste_feil_hvis_søknad_ikke_eksisterer() {
    ...
    @Test
    public void skal_kaste_feil_hvis_søknad_mangler_journalpostID() {
    ...
    @Test
    public void skal_lagre_saksnummer_på_søknad() {
